...
![[Pasted image 20251123170633.png]]
...
> **Q.** 위 식의 유도 과정은 무엇인가?
> **A.** ![[Pasted image 20251123170829.png]]
...
#### Algorithm 1
![[Pasted image 20251123171028.png]]
...
ELBO의 KL발산 항은 근사사후분포와 사전분포 사이의 규제(인코더가 데이터x를 잠재공간으로 보낼 때, 그 분포가 정규분포 모양을 갖추도록 강제)역할이며, 다른 항은 음의 재구성 오차($\text{log p}_{\theta}(x^{(i)}|z)$, z에서 x로 복원했을 때 오차가 작아야 = 우도가 높아야 함)를 의미함.
